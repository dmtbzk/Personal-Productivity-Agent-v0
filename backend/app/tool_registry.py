TOOLS = [
    ...
    },
   {
    "type": "function",
    "name": "add_habit",
    "description": "Adds a new habit for the user to track. Use this when the user wants to create, start, or track a repeated habit.",
    "parameters": {
        "type": "object",
        "properties": {
            "name": {
    ...
    },
    {
        "type": "function",
        "name": "list_habits",
        "description": "Returns the user's tracked habits. Use this when the user asks about their habits or wants to review habit tracking.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
    ...
    },
    {
        "type": "function",
        "name": "complete_habit",
        "description": "Marks a habit as completed by habit id. Use this when the user says they completed or did a habit today.",
        "parameters": {
            "type": "object",
            "properties": {
                "habit_id": {
